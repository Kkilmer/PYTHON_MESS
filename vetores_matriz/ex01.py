...
#Escreva um algoritmo que permita a leitura dos nomes de 10 clubes 
#de futebol e armazene os nomes lidos em um vetor (lista). Após isto, 
#o algoritmo deve permitir a leitura de mais 1 nome qualquer de clube e depois 
